...
export default function Footer() {
  ...
  return (
    <footer className='bg-black/60 text-white underline-link backdrop-blur-md'>
      <div className='w-full'>
        <Button
          variant='ghost'
          className='bg-gray-800/60 w-full rounded-none backdrop-blur-sm hover:bg-gray-700/70'
